...
{
    /**
     * @var BaseApplication|WebApplication|ConsoleApplication|MyApp the application instance
     */
    public static $app;
}
class MyApp extends  WebApplication {
    /**
     * @var app\components\PbDataRetriever pb data retriever
     */
    public static $dataretriever;
